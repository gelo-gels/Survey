    ...
    <div class="container_form">
    	...
    	<div class="text-bold font-poppins-bold font_sizing q-mb-lg" v-if="name_submits == true">
	    	...
	    	<div class="font-poppins-bold" v-if="name_submits == true">
	    		<q-input required type="text" name="message" v-model="form.message" borderless label="message"/>
		    ...
		    <div class="font-poppins-bold" v-if="name_submits == true">
		    	<q-btn no-caps type="submit" label="Submit" class="btns" />
		    </div>
    	...
    	<div class="row font-poppins-bold">
	    	<div class="col-6" v-if="survey == true">
	    		<q-btn no-caps label="Oo" class="btns" @click="click_oo()" />
	    	</div>
	    ...
	    <div v-if="word_reveal == true" class="text-bold font-poppins-bold font_sizing q-mb-xl">
    		YIEEE KELEG KELEG AKO BHIE HEHE SABI NA E
    	</div>
    </div>
</form>
